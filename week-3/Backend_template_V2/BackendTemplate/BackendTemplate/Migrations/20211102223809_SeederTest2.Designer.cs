...
namespace BackendTemplate.Migrations
{
    ...
    [Migration("20211102223809_SeederTest2")]
    partial class SeederTest2
    {
            ...
            modelBuilder.Entity("BackendTemplate.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Description = "Error vel quos amet maxime ea. Est enim ipsa ratione ipsa. Commodi facere velit explicabo. Quas reiciendis ut ea et. Libero magni dicta inventore dolor illo voluptas. Ullam quia molestias a voluptas quis enim quibusdam neque.",
                            Price = 0,
                            Title = "Faker.Extensions.EnumerableExtensions+<Times>d__0`1[System.String]"
                        });
                });
