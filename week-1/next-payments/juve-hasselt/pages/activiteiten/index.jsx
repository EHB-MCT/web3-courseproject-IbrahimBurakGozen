...
import { activiteitenProducten } from "../../public/producten/activiteiten-producten";
import Alert from '../../components/alert';
import { handleChangePersonal, handleChangeProducts } from "../../utils/changeHandler";
import { calculateTotal } from "../../utils/calculate";

const personalData = [{type:"activiteiten"}]
let productData = []
...
export default function Activiteiten() {
  ...
  const handleProductChange = (event)=>{
    ...
    const newPrice = calculateTotal(productData, activiteitenProducten);
    setTotal(newPrice);
  }
      ...
      */}
      ...
      <form onSubmit={handleSubmit}>
          ...
          <div className="producten-container">
            {
              /* De producten */
              activiteitenProducten.map((product,index) =>{
                return (
                  <div key={index}>
