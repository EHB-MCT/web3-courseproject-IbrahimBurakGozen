...
const SideNavigation = () => {
  ...
  return (
    <nav className={styles.mobileContainer}>
        ...
        <Link href="/">
        <a className={router.pathname == "/" ? styles.currentPage : styles.link}>{iconHome}</a>
        </Link>

        <Link href="/products">
        <a className={router.pathname == "/products" ? styles.currentPage : styles.link}>{iconList}</a>
        </Link>

        <Link href="/products">
        <a className={styles.link, styles.addButton}>{iconAdd}</a>
        </Link>

        <Link href="/products">
        <a className={styles.link}>{iconVoorlopig}</a>
        </Link>

        <Link href="/products">
        <a className={styles.link} ><span ><img src="https://picsum.photos/30/30" alt="" /></span></a>
        </Link>
